                    ...
                    @endrole
                        ...
                        @else
                            <span style="font-size: 18px; font-weight: 700;">
                                {{ $settingWeb->nama_perusahaan ?? config('app.name') }}
                            </span>
                        @endif
                    </a>
                </div>
                        ...
                        <ul class="submenu">
                            ...
                            @if (\App\Services\TenantEntitlementService::featureEnabled('payment_gateway', false))
                                <li class="submenu-item{{ request()->is('tenant/payment-settings') ? ' active' : '' }}">
                                    <a href="{{ route('tenant.payment.settings') }}">Payment</a>
                                </li>
                            @endif
                            @if (\App\Services\TenantEntitlementService::featureEnabled('whatsapp', false))
                                <li class="submenu-item{{ request()->is('tenant/wa-settings') ? ' active' : '' }}">
                                    <a href="{{ route('tenant.wa.settings') }}">WA Settings</a>
                                </li>
                                <li class="submenu-item{{ request()->is('tenant/wa-report') ? ' active' : '' }}">
