            ...
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        {{ __('Berikut adalah daftar semua banner Management.') }}
                    </p>
                </div>
                <x-breadcrumb>
                    <li class="breadcrumb-item"><a href="/dashboard">{{ __('Dashboard') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Banner Management') }}</li>
                </x-breadcrumb>
            </div>
        </div>
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        return `<div>
                            <img src="${data}" alt="File Banner" style="width:200px" >
                        </div>`;
                        }
                    },
				{
