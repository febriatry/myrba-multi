@extends('layouts.app')
@section('title', 'Detail Transaksi Stok Masuk')
@section('content')
    <div class="page-heading">
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    <h3>Detail Transaksi Stok Masuk</h3>
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('transaksi-stock-in.index') }}" class="btn btn-secondary mt-3">Kembali</a>
                </div>
            </div>
        </section>
    </div>
