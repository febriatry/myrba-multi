                    ...
                    <form action="{{ route('hr-shifts.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="break_minutes" class="form-control" value="{{ old('break_minutes', 60) }}">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('hr-shifts.index') }}" class="btn btn-light">{{ __('Batal') }}</a>
                        </div>
                    </form>
                </div>
            </div>
