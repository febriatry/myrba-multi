...
@section('title', __('Tambah Rule Bagi Hasil'))
...
@section('content')
    <div class="page-heading">
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    <h3>{{ __('Tambah Rule Bagi Hasil') }}</h3>
                </div>
            </div>
        </div>
        <section class="section">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('investor-share-rules.store') }}" method="post">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="rule_type" class="form-control" required>
                                <option value="per_customer">per_customer</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="start_period" class="form-control" placeholder="2026-03">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="amount_value" class="form-control" required>
                        </div>
                        <div class="mb-3">
