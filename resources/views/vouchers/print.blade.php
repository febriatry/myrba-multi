...
<head>
    <title>Voucher-{{ $settingWeb->nama_perusahaan }}</title>
            ...
            <tbody>
                <tr>
                    <td style="text-align: left; font-size: 14px; font-weight:bold; border-bottom: 1px black solid;"><img
                            src="{{ asset('storage/uploads/logos/' . $settingWeb->logo) }}" alt="logo"
                            style="height:30px;border:0;"> {{ $settingWeb->nama_perusahaan }} <span
