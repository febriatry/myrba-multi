...
@section('title', __('Potongan Sanksi'))
    ...
    <div class="page-heading">
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    <h3>{{ __('Potongan Sanksi') }}</h3>
                    <p class="text-subtitle text-muted">{{ __('Input sanksi/potongan manual per hari.') }}</p>
                </div>
                <x-breadcrumb>
                    <li class="breadcrumb-item"><a href="/dashboard">{{ __('Dashboard') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Potongan Sanksi') }}</li>
                </x-breadcrumb>
            </div>
        </div>
        ...
        <section class="section">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <form class="d-flex gap-2" method="GET" action="{{ route('hr-sanctions.index') }}">
