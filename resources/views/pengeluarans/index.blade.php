            ...
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        {{ __('Berikut adalah daftar semua Pengeluaran.') }}
                    </p>
                </div>
                <x-breadcrumb>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    <div class="card border-start border-0 border-3 border-danger">
                                        <div class="card-body">
                                            <p class="mb-0 text-secondary">Jumlah Pengeluaran</p>
                                            <h4 class="my-1 text-danger" id="expense-count">0</h4>
                                            <p class="mb-0 text-secondary">Total Pengeluaran</p>
                                            <h6 class="my-1 text-danger" id="expense-sum">Rp 0</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function updateSummary() {
            var s = {
                ...
                kategori_pengeluaran: $('select[name=kategori_pengeluaran]').val(),
            };
            $.get("{{ route('pengeluarans.summary') }}", s, function (res) {
                $('#expense-count').text(res.count ?? 0);
                $('#expense-sum').text(res.sum ?? 'Rp 0');
            });
        }
