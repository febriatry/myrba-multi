    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            @if ($model->status_berlangganan == 'Menunggu')
                @can('pelanggan edit')
                    <li>
                        <a href="{{ route('pelanggans-request.materials', $model->id) }}" class="dropdown-item">Material Gudang</a>
                    </li>
                    <li>
                        @if (($model->material_status ?? 'Pending') === 'Approved')
                            <a href="{{ route('pelanggans.edit', $model->id) }}" class="dropdown-item">Validasi</a>
                        @else
                            <button class="dropdown-item" disabled>Validasi (Menunggu Gudang)</button>
                        @endif
                    </li>
                @endcan
            @endif
