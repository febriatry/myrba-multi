            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="latitude" id="latitude"
                        ...
                        value="{{ isset($pelanggan) ? $pelanggan->latitude : old('latitude') }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="longitude" id="longitude"
                        ...
                        value="{{ isset($pelanggan) ? $pelanggan->longitude : old('longitude') }}"
...
@push('js')
    <script>
        ...
        function initMap() {
            var initialLatitude = parseFloat("{{ isset($pelanggan) ? $pelanggan->latitude : -6.2088 }}");
            var initialLongitude = parseFloat("{{ isset($pelanggan) ? $pelanggan->longitude : 106.8456 }}");
