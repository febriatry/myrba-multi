        ...
        <section class="section">
            <div class="row">
                <div class="row mb-2 align-items-center">
                    <form action="{{ route('laporans.index') }}" method="GET" class="row mb-2 align-items-center">
                        <div class="col-auto">
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                <input type="date" class="form-control" name="start_date" value="{{ $start ?? '' }}">
                                <input type="date" class="form-control ms-2" name="end_date" value="{{ $end ?? '' }}">
                            </div>
                        </div>
                        ...
                        <div class="col-auto ms-2 d-flex gap-2">
                            ...
                            @if ($start && $end)
                                <a href="{{ route('laporans.exportPdf', ['start_date' => $start, 'end_date' => $end]) }}"
                                    class="btn btn-danger" target="_blank">
                                    <i class="fas fa-file-pdf"></i> Cetak PDF
                                </a>
                                <a href="{{ route('laporans.exportKas', ['start_date' => $start, 'end_date' => $end]) }}"
                                    class="btn btn-primary" target="_blank">
                                    <i class="fas fa-book"></i> Export Buku Kas
                                </a>
                            @endif
                        </div>
                    </form>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @foreach ($pemasukans as $pemasukan)
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ rupiah($pemasukan->total_nominal) }}
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @foreach ($pengeluarans as $pengeluaran)
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ rupiah($pengeluaran->total_nominal) }}
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
