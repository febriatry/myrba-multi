...
class Pelanggan extends Model
{
     ...
     * @var string[]
     */
    protected $casts = ['tenant_id' => 'integer', 'no_layanan' => 'integer', 'nama' => 'string', 'tanggal_daftar' => 'date:d/m/Y', 'email' => 'string', 'no_wa' => 'integer', 'no_ktp' => 'string', 'photo_ktp' => 'string', 'alamat' => 'string', 'password' => 'string', 'pending_paket_layanan' => 'integer', 'pending_paket_requested_at' => 'datetime:Y-m-d H:i:s', 'jatuh_tempo' => 'integer', 'latitude' => 'string', 'longitude' => 'string', 'tempo_isolir' => 'integer', 'user_pppoe' => 'string', 'material_approved_at' => 'datetime:Y-m-d H:i:s', 'referral_bonus_paid_at' => 'datetime:Y-m-d H:i:s', 'created_at' => 'datetime:d/m/Y H:i', 'updated_at' => 'datetime:d/m/Y H:i'];
    /**
