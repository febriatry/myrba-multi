...
class ViewComposerServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::composer(['barangs.create', 'barangs.edit'], function ($view) {
            return $view->with(
                'unitSatuans',
        ...
        View::composer(['barangs.create', 'barangs.edit'], function ($view) {
            return $view->with(
                'kategoriBarangs',
                \App\Models\KategoriBarang::select('id', 'nama_kategori_barang')->get()
            );
        });

        View::composer(['tiket-aduans.create', 'tiket-aduans.edit'], function ($view) {
            return $view->with(
                'pelanggans',
                \App\Models\Pelanggan::select('id', 'nama')->get()
            );
