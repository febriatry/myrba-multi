...
class TenantPlatformController extends Controller
{
    ...
    public function update(Request $request, Tenant $tenant)
    {
        $validated = $request->validate([
            ...
            'status' => 'required|string|in:active,suspended',
            'plan_id' => 'required|integer|exists:tenant_plans,id',
            'override_feature_finance' => 'nullable|in:1,0',
            'override_feature_pelanggan' => 'nullable|in:1,0',
            'override_feature_layanan' => 'nullable|in:1,0',
            'override_feature_network' => 'nullable|in:1,0',
            'override_feature_pppoe' => 'nullable|in:1,0',
            'override_feature_hotspot' => 'nullable|in:1,0',
            'override_feature_investor' => 'nullable|in:1,0',
            'override_feature_cms' => 'nullable|in:1,0',
            'override_feature_settings' => 'nullable|in:1,0',
        ...
        $features = [];
        $map = [
            'finance' => 'override_feature_finance',
            'pelanggan' => 'override_feature_pelanggan',
            'layanan' => 'override_feature_layanan',
            'network' => 'override_feature_network',
            'pppoe' => 'override_feature_pppoe',
            'hotspot' => 'override_feature_hotspot',
            'investor' => 'override_feature_investor',
            'cms' => 'override_feature_cms',
            'settings' => 'override_feature_settings',
