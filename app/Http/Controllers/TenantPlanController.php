...
class TenantPlanController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'feature_finance' => 'nullable|in:1,0',
            'feature_pelanggan' => 'nullable|in:1,0',
            'feature_layanan' => 'nullable|in:1,0',
            'feature_network' => 'nullable|in:1,0',
            'feature_pppoe' => 'nullable|in:1,0',
            'feature_hotspot' => 'nullable|in:1,0',
            'feature_investor' => 'nullable|in:1,0',
            'feature_cms' => 'nullable|in:1,0',
            'feature_settings' => 'nullable|in:1,0',
        ...
        $features = [
            'finance' => isset($validated['feature_finance']) ? ((int) $validated['feature_finance'] === 1) : true,
            'pelanggan' => isset($validated['feature_pelanggan']) ? ((int) $validated['feature_pelanggan'] === 1) : true,
            'layanan' => isset($validated['feature_layanan']) ? ((int) $validated['feature_layanan'] === 1) : true,
            'network' => isset($validated['feature_network']) ? ((int) $validated['feature_network'] === 1) : true,
            'pppoe' => isset($validated['feature_pppoe']) ? ((int) $validated['feature_pppoe'] === 1) : true,
            'hotspot' => isset($validated['feature_hotspot']) ? ((int) $validated['feature_hotspot'] === 1) : true,
            'investor' => isset($validated['feature_investor']) ? ((int) $validated['feature_investor'] === 1) : true,
            'cms' => isset($validated['feature_cms']) ? ((int) $validated['feature_cms'] === 1) : true,
            'settings' => isset($validated['feature_settings']) ? ((int) $validated['feature_settings'] === 1) : true,
            'whatsapp' => isset($validated['feature_whatsapp']) ? ((int) $validated['feature_whatsapp'] === 1) : true,
            'payment_gateway' => isset($validated['feature_payment_gateway']) ? ((int) $validated['feature_payment_gateway'] === 1) : true,
            'inventory' => isset($validated['feature_inventory']) ? ((int) $validated['feature_inventory'] === 1) : true,
            'hr' => isset($validated['feature_hr']) ? ((int) $validated['feature_hr'] === 1) : true,
